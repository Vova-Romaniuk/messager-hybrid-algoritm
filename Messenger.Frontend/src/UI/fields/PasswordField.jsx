...
export default function PasswordTextField({
	...
	return (
		<div className={`relative text-[${primaryGray}] flex flex-col`}>
			...
			<input
				className={`active:border-none w-full static text-[#506466] my-3 outline-none h-10 px-3 py-1 font-normal rounded-xl border-solid border-2 placeholder:decoration-[#A0A9AB] text-base border-[#D1D7D4] ${className}`}
